  ...
  return (
    <Layout>
      <h1 className="text-white text-6xl font-bold mb-8">With Them</h1>
        <div className="flex flex-col items-center space-y-4"> {/* Add space-y-4 for vertical space between buttons */}
        <ButtonComponent onClick={() => { window.location.href = "/join-lobby"; }} label="Join Lobby" />
